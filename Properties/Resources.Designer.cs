...
namespace Nfu.Properties {
    ...
    internal class Resources {
        ...
        /// <summary>
        ///   Looks up a localized string similar to %s = second, %m = minute, %h = hour
        ///%D = day, %M = month, %Y = year
        ///%C = count, %? = random character.
        /// </summary>
        internal static string GeneratedFileNameCharacters {
            get {
                return ResourceManager.GetString("GeneratedFileNameCharacters", resourceCulture);
            }
        }
        
        /// <summary>
        ///   Looks up a localized string similar to Generated filename pattern.
        /// </summary>
        internal static string GeneratedFileNamePattern {
            get {
                return ResourceManager.GetString("GeneratedFileNamePattern", resourceCulture);
            }
        }
